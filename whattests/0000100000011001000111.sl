...
(define-fun pstr ((x String) (s String) (t String) (q String) (l String)) String (str.replace (str.replace x s t) q l))
...
(
 ...
 (ntString String(
    ...
    (pstr ntString ntString ntString ntString ntString)
